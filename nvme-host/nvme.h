...
#define NVME_DEBUG
#ifdef NVME_DEBUG
#define nvme_debug(fmt, ...) printk(KERN_DEBUG "%s: (%s, %u): " fmt "\n", __FILE__, __func__, __LINE__, ##__VA_ARGS__);
#else
#define nvme_debug(n, fmt, a...) /**/
#endif
/* end */
...
struct nvme_queue {
	...
	unsigned long old_time_in_queue; 
	unsigned long stamp;
#endif
};
...
struct nvme_dev {
	...
	struct timer_list iostat_timer;
	u64 iostat_interval;
#endif
};

#ifdef CONFIG_NVME_DEBUGFS
int nvme_create_root_stats(void);
